...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ludum-dare-venus", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ludum-dare-venus", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ludum-dare-venus";
		app.meta["name"] = "ludum-dare-venus";
